...
$res = $db->query("SELECT call,tx_frequency,mode,qso_start,my_call FROM qso_table_v007 where qso_start between '2022-02-05 06:00:00' AND '2022-02-05 18:00:00' order by qso_start");
