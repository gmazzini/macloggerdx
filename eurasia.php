...
$res = $db->query("SELECT call,tx_frequency,mode,qso_start,my_call,grid,rst_sent,rst_received FROM qso_table_v007 where qso_start>=$from and qso_start<=$to order by qso_start");
